...
//      t1.start();
    ...
    class ServerThread extends Thread{
    	...
    	//클라이언트당 닉네임이 하나씩 존재하기때문에
    	//클라이언트당 하나씩 존재하는 thread의 멤버변수로 nick을 가진다.
            ...
            try {
               ...
               //소켓으로부터 메시지를 읽어오는 부분   
                while(true) {
                    ...
                    String type = st.nextToken();	//nextToken토큰 읽어오기,return타입은 String
                    //두번째 토큰을 저장하는 변수 outMsg: 채팅내용, 닉네임이 될 수 있음
                    outMsg = st.nextToken();
